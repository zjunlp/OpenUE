...
def IEDemo():
    ...
    if True:
        ...
        for item in predicate_predict:
            ...
            text2_raw = text + "\t" + item
            resp = requests.post('http://'+config.tf_serving_addr+'/v1/models/seq_med:predict', json=preprocess(text2,'seq'))
...
if __name__ == '__main__':
    server = pywsgi.WSGIServer(('127.0.0.1', 8890), app)
