...
else{echo "《来自星星的你》是由张太侑导演，朴智恩编剧，金秀贤、全智贤、刘仁娜、朴海镇等主演的爱情科幻喜剧，于2013年12月18日在韩国SBS电视台首播。";
}?></textarea>
                    <div class="input-group-append">
                        <button class="btn btn-outline-secondary" type="submit" >Extract Knowledge Triples</button>
                    </div>
                </div>
            </div>
</form>
...
<?php
if(strlen($query1) > 0){
    $cmd = "python get_openue.py \"$query1\" \"$model\"";
    $res = shell_exec($cmd);
    echo $res;
}
?>
