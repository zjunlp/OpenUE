...
echo $query1;
    ...
    echo "支气管炎、咽喉炎的常见症状有咳嗽、咳痰、气喘等，可以到医院做血常规和x线检查以及痰检检查等确诊，口服阿莫西林颗粒和清热止咳化痰口服液。";
}?></textarea>
                    <div class="input-group-append">
                        <button class="btn btn-outline-secondary" type="submit" >Extarct Medical Triples</button>
                    </div>
                </div>
            </div>
</form>
