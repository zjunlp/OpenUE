from utils import Split, get_labels_ner, get_labels_seq
from utils import OpenUEDataset, openue_data_collator_ner
from dataclasses import dataclass, field
from tqdm.auto import tqdm
from typing import Optional, Dict, Union, Any
from distill_model import TinyBertForNER, BertForNER
...
def _prepare_dataloader(dataset, training_args):
    ...
    dataloader = DataLoader(
            ...
            sampler=sampler,
            collate_fn=openue_data_collator_ner,
...
def main():
    ...
    tokenizer = AutoTokenizer.from_pretrained(teacher_config._name_or_path, use_fast=False,)
    teacher_model = BertForNER.from_pretrained(model_args.model_path,config=teacher_config,).to(device)
    student_model = TinyBertForNER.from_pretrained("hfl/rbt3",config=student_config,).to(device)
