...
def convert_class_to_features(example, max_seq_length, tokenizer):
    label_map = {}
...
def convert_seq_to_features(example,max_seq_length, tokenizer,predicate_label_list):
    predicate_label_map = {}
