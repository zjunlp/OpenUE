...
if __name__ == '__main__':
    ...
    golden_filename = os.path.join(
        os.path.abspath(os.path.join(os.path.dirname(__file__), "../../raw_data")), "valid.json")
    predict_filename = os.path.join(
        os.path.abspath(os.path.join(os.path.dirname(__file__), "../../output/predict_text_spo_list_result")),
