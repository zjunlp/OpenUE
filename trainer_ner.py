...
class Trainer:
    ...
    def prediction_loop(
        ...
        for inputs in tqdm(dataloader, desc=description):
            ...
            if labels is not None:
                ...
                label_ids.append(labels.tolist())
        ...
        if self.compute_metrics is not None and preds is not None and label_ids is not None:
            metrics = self.compute_metrics(predictions=preds, label_ids=label_ids, label_map_ner=self.label_map_ner)
        else:
            metrics = {}
    ...
    def prediction_step(
        ...
        labels = inputs.get("label_ids_ner")
        if labels is not None:
